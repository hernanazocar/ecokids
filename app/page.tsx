      ...
      <section id="servicios" className="relative py-16 px-6 overflow-hidden bg-gradient-to-br from-pink-50 via-rose-50 to-orange-50">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            ...
            <div className="group bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-pink-200 hover:border-pink-400 hover:-translate-y-1">
              <div className="w-14 h-14 bg-gradient-to-br from-pink-400 to-rose-500 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                <svg className="w-7 h-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" />
                </svg>
              </div>
              ...
              <p className="text-gray-600 mb-4 leading-relaxed">
                Arte, manualidades y actividades sensoriales que estimulan la creatividad.
              </p>
              <div className="space-y-2 mb-4">
                ...
                <div className="flex items-center gap-2 text-sm text-gray-700">
                  ...
                  <span>Actividades sensoriales</span>
                </div>
              </div>
              <button className="w-full py-2.5 bg-gradient-to-r from-pink-500 to-rose-500 text-white rounded-xl font-semibold hover:shadow-lg transition-all">
                Ver Talleres
              </button>
            </div>
            ...
            <div className="group bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-purple-200 hover:border-purple-400 hover:-translate-y-1">
              ...
              <p className="text-gray-600 mb-4 leading-relaxed">
                Celebraciones personalizadas con actividades temáticas y mucha diversión.
              </p>
              <div className="grid grid-cols-2 gap-2 mb-4">
                <div className="bg-purple-100 rounded-lg p-2 text-center border border-purple-200">
                  <div className="text-lg font-bold text-purple-600">3hrs</div>
                  <div className="text-xs text-purple-700">Duración</div>
                </div>
            ...
            <div className="group bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-blue-200 hover:border-blue-400 hover:-translate-y-1">
              <div className="flex items-center justify-between mb-4">
                ...
                <span className="bg-blue-500 text-white px-3 py-1 rounded-full text-xs font-bold">Especial</span>
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Bajo el Mar</h3>
              <p className="text-gray-600 mb-4 leading-relaxed">
                Aventura temática marina con actividades acuáticas del océano.
              </p>
              <div className="bg-gradient-to-r from-blue-100 to-cyan-100 rounded-xl p-3 mb-4 border border-blue-200">
                <div className="flex items-center justify-between">
                  <span className="text-sm text-blue-900 font-semibold">Precio especial</span>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="group bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-blue-200 hover:border-blue-400 hover:-translate-y-1">
              ...
              <div className="inline-block px-3 py-1 bg-blue-100 rounded-full text-xs font-bold text-blue-700 mb-3">
                Paso 1
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Explora</h3>
              <p className="text-gray-600 leading-relaxed">
                Navega por nuestros talleres y experiencias según la edad de tu hijo.
              </p>
            </div>

            {/* Paso 2 */}
            <div className="group bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-cyan-200 hover:border-cyan-400 hover:-translate-y-1">
              <div className="w-14 h-14 bg-gradient-to-br from-cyan-400 to-teal-500 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                <svg className="w-7 h-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
              </div>
              <div className="inline-block px-3 py-1 bg-cyan-100 rounded-full text-xs font-bold text-cyan-700 mb-3">
                Paso 2
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Reserva</h3>
              <p className="text-gray-600 leading-relaxed">
                Agenda tu fecha preferida vía WhatsApp, Instagram o formulario.
              </p>
            </div>

            {/* Paso 3 */}
            <div className="group bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-green-200 hover:border-green-400 hover:-translate-y-1">
              <div className="w-14 h-14 bg-gradient-to-br from-green-400 to-emerald-500 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                <svg className="w-7 h-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <div className="inline-block px-3 py-1 bg-green-100 rounded-full text-xs font-bold text-green-700 mb-3">
                Paso 3
              </div>
              <h3 className="text-xl font-bold text-gray-900 mb-2">Disfruta</h3>
              <p className="text-gray-600 leading-relaxed">
                ¡Llega el día y deja que tu hijo explore y se divierta!
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            ...
            <div className="group bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-green-200 hover:border-green-400 hover:-translate-y-1">
              ...
              <p className="text-gray-600 mb-3 leading-relaxed">
                Respuesta inmediata para agendar
              </p>
              <div className="bg-green-100 rounded-xl p-3 mb-3 border border-green-200">
                <p className="text-green-900 font-bold text-center">+56 9 XXXX XXXX</p>
              </div>
              <button className="w-full py-2.5 bg-gradient-to-r from-green-500 to-emerald-500 text-white rounded-xl font-semibold hover:shadow-lg transition-all">
                Enviar mensaje
              </button>
            </div>
            ...
            <div className="group bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-purple-200 hover:border-purple-400 hover:-translate-y-1">
              ...
              <div className="bg-purple-100 rounded-xl p-3 mb-3 border border-purple-200">
            ...
            <div className="group bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border-2 border-blue-200 hover:border-blue-400 hover:-translate-y-1">
              ...
              <div className="bg-blue-100 rounded-xl p-3 mb-3 border border-blue-200">
                <p className="text-blue-900 font-bold text-center">Concón, V Región</p>
              </div>
