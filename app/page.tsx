...
export default function Home() {
  ...
  useEffect(() => {
    const cargarDatos = async () => {
      try {
        const [expRes, testRes, faqsRes, galRes, configRes] = await Promise.all([
        ...
        setExperiencias(expData.experiencias || []);
        setTestimonios(testData.testimonios || []);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-100 to-pink-100">
        <div className="text-center">
          ...
          <p className="text-orange-600 font-bold text-lg">Cargando EcoKids...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#f5f2ed]">
      ...
      <section className="relative py-16 px-6 overflow-hidden bg-gradient-to-br from-yellow-50 via-orange-50 to-pink-50">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="flex gap-3 md:gap-4 overflow-x-auto pb-4 scrollbar-hide mb-6 md:mb-8 px-4 md:px-0 -mx-4 md:mx-0">
            {galeria?.imagenes?.map((imagen: any, index: number) => (
              <div
                key={imagen.id}
          ...
          <div className="text-center mt-6 md:mt-8 px-4">
            <a
              href={galeria?.instagram?.url || "https://instagram.com/ecokids.experiencias"}
              target="_blank"
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3 mb-12">
            ...
            >
              ...
              <div className={`overflow-hidden transition-all ${openFaq === 0 ? 'max-h-96' : 'max-h-0'}`}>
                <p className="text-sm text-gray-700 leading-relaxed">
                  Nuestras experiencias están diseñadas para niños de 3 a 12 años. Adaptamos todas las actividades según la edad de cada grupo para garantizar que todos disfruten y aprendan de manera segura y divertida.
                </p>
              </div>
            </div>
            ...
            >
              ...
              <div className={`overflow-hidden transition-all ${openFaq === 2 ? 'max-h-96' : 'max-h-0'}`}>
                <p className="text-sm text-gray-700 leading-relaxed">
                  Todos los materiales están incluidos en nuestras aventuras, así cada niño pueda vivir la experiencia al máximo.
                </p>
              </div>
            </div>
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="flex-grow flex flex-col justify-between gap-2">
                  <div className="bg-white/80 backdrop-blur rounded-xl p-2 border-2 border-green-300 shadow-md">
                    <p className="text-green-900 font-bold text-center text-sm">{configuracion?.contacto?.telefono || '+56 9 2008 9281'}</p>
                  </div>
                  <a href={`https://wa.me/${configuracion?.contacto?.whatsapp || '56920089281'}`} target="_blank" rel="noopener noreferrer" className="w-full block mt-auto">
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="flex-grow flex flex-col justify-between gap-2">
                  <div className="bg-white/80 backdrop-blur rounded-xl p-2 border-2 border-purple-300 shadow-md">
                    <p className="text-purple-900 font-bold text-center text-sm">{configuracion?.redesSociales?.instagram?.usuario || '@ecokids.experiencias'}</p>
                  </div>
                  <a href={configuracion?.redesSociales?.instagram?.url || 'https://instagram.com/ecokids.experiencias'} target="_blank" rel="noopener noreferrer" className="w-full block mt-auto">
              ...
              <div className="relative z-10 flex flex-col h-full">
                ...
                <div className="flex-grow flex flex-col justify-between gap-2">
                  <div className="bg-white/80 backdrop-blur rounded-xl p-2 border-2 border-orange-300 shadow-md">
                    <p className="text-orange-900 font-bold text-center text-xs">{configuracion?.contacto?.email || 'Ecokids.experiencias@gmail.com'}</p>
                  </div>
                  <a href={`mailto:${configuracion?.contacto?.email || 'Ecokids.experiencias@gmail.com'}`} className="w-full block mt-auto">
                ...
                <div className="grid md:grid-cols-2 gap-3">
                  ...
                  <div>
                    ...
                    <input
                      type="tel"
                      className="w-full px-3 py-2 rounded-xl border-2 border-gray-200 focus:ring-2 focus:ring-orange-500 focus:border-transparent outline-none transition-all text-sm text-gray-900 placeholder:text-gray-400"
                      placeholder={configuracion?.contacto?.telefono || "+56 9 2008 9281"}
                    />
                  </div>
                </div>
                <div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="md:col-span-2">
              <div className="mb-4">
                <span className="text-2xl font-bold">{configuracion?.sitio?.nombre || 'EcoKids'}</span>
              </div>
              <p className="text-white/90 mb-4 max-w-md">
                {configuracion?.footer?.textoLegal || configuracion?.sitio?.descripcion || 'Experiencias creativas para niños en Concón.'}
              </p>
              <div className="text-sm text-white/80">
                {configuracion?.sitio?.tagline || 'Un ratito sin pantallas, un mundo de posibilidades'}
              </div>
            </div>

            {configuracion?.footer?.enlaces && configuracion.footer.enlaces.length > 0 && (
              <div>
                <h4 className="font-semibold mb-4">Enlaces</h4>
                <ul className="space-y-2 text-white/90">
                  {configuracion.footer.enlaces.map((enlace: any, index: number) => (
                    <li key={index}>
                      <a href={enlace.url} className="hover:text-white transition-colors">
                        {enlace.texto}
                      </a>
                    </li>
                  ))}
            ...
            <div>
              ...
              <ul className="space-y-3 text-white/90 text-sm">
                {configuracion?.contacto?.ubicacion && (
                  <li className="flex items-start gap-2">
                    <svg className="w-4 h-4 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                    </svg>
                    <span>
                      {configuracion.contacto.ubicacion.direccion && `${configuracion.contacto.ubicacion.direccion}, `}
                      {configuracion.contacto.ubicacion.ciudad || 'Concón'}, {configuracion.contacto.ubicacion.region || 'V Región'}, {configuracion.contacto.ubicacion.pais || 'Chile'}
                    </span>
                  </li>
                )}
                {configuracion?.contacto?.telefono && (
                  <li className="flex items-center gap-2">
                    ...
                    <a href={`tel:${configuracion.contacto.telefono.replace(/\s/g, '')}`} className="hover:text-white transition-colors">
                      {configuracion.contacto.telefono}
                    </a>
                  </li>
                )}
                {configuracion?.contacto?.email && (
                  <li className="flex items-center gap-2">
                    ...
                    <a href={`mailto:${configuracion.contacto.email}`} className="hover:text-white transition-colors break-all">
                      {configuracion.contacto.email}
                    </a>
                  </li>
                )}
                {configuracion?.redesSociales?.instagram?.url && (
                  <li className="flex items-center gap-2">
                    <svg className="w-4 h-4 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/>
                    </svg>
                    <a href={configuracion.redesSociales.instagram.url} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                      {configuracion.redesSociales.instagram.usuario || '@ecokids.experiencias'}
                    </a>
                  </li>
                )}
                {configuracion?.redesSociales?.facebook?.url && (
                  <li className="flex items-center gap-2">
                    <svg className="w-4 h-4 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                    </svg>
                    <a href={configuracion.redesSociales.facebook.url} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                      Facebook
                    </a>
                  </li>
                )}
                {configuracion?.redesSociales?.whatsapp?.url && (
                  <li className="flex items-center gap-2">
                    <svg className="w-4 h-4 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413Z"/>
                    </svg>
                    <a href={configuracion.redesSociales.whatsapp.url} target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                      WhatsApp
                    </a>
                  </li>
                )}
          ...
          <div className="pt-8 border-t border-white/20 text-center text-white/80 text-sm">
            {configuracion?.footer?.copyright || `© ${new Date().getFullYear()} ${configuracion?.sitio?.nombreCompleto || 'EcoKids - Experiencias Creativas'}. Todos los derechos reservados.`}
          </div>
        </div>
      </footer>
            ...
            <div className="bg-white rounded-3xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl" onClick={(e) => e.stopPropagation()}>
              ...
              <div className="p-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <a
                    href={`https://wa.me/${configuracion?.contacto?.whatsapp || '56920089281'}`}
                    target="_blank"
                    rel="noopener noreferrer"
      ...
      <div className="fixed bottom-6 right-6 z-50">
        ...
        {/* Panel del chat */}
        {showChatbot && (
          <div className="fixed md:absolute bottom-2 md:bottom-20 left-2 right-2 md:left-auto md:right-0 md:w-96 h-[75vh] md:h-[600px] bg-white rounded-3xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-300 flex flex-col border border-gray-100">
            {/* Header moderno */}
                          ...
                          onClick={() => {
                            ...
                            setTimeout(() => {
                              ...
                              if (lowerMsg.includes('edad')) {
                                ...
                                response = saludo + `¡Me encanta tu entusiasmo! 🎉 Puedes reservar súper fácil por WhatsApp (${configuracion?.contacto?.telefono || '+56 9 2008 9281'}), Instagram (${configuracion?.redesSociales?.instagram?.usuario || '@ecokids.experiencias'}) o llenando nuestro formulario. ¿Para cuándo estás pensando?`;
                ...
                onSubmit={(e) => {
                  ...
                  setTimeout(() => {
                    ...
                    // Detectar días de la semana y fechas
                      ...
                      response = saludo + `¡Entendido! 😊 Igual estoy aquí si se te ocurre alguna duda. ¿Hay algo más en lo que pueda ayudarte? También puedes contactarnos cuando quieras por WhatsApp (${configuracion?.contacto?.telefono || '+56 9 2008 9281'}).`;
                      ...
                      response = saludo + `¡Me encanta tu entusiasmo! 🎉 Puedes reservar súper fácil por WhatsApp (${configuracion?.contacto?.telefono || '+56 9 2008 9281'}), Instagram (${configuracion?.redesSociales?.instagram?.usuario || '@ecokids.experiencias'}) o llenando nuestro formulario aquí mismo en la web. ¿Para cuándo estás pensando? ¿Es para un cumple o una experiencia regular?`;
                    } else if (lowerMsg.includes('ubic') || lowerMsg.includes('dónde') || lowerMsg.includes('donde')) {
                      ...
                      response = saludo + `Los precios varían según la experiencia y cantidad de niños. 💰 Para darte un precio exacto, ¿me cuentas cuántos niños serían y qué tipo de experiencia te interesa? También puedes escribirnos por WhatsApp (${configuracion?.contacto?.telefono || '+56 9 2008 9281'}) y te armamos una cotización personalizada al toque.`;
                      ...
                      response = `¡Hasta pronto! 👋 ¡Que tengas un día increíble! Si necesitas algo más, aquí estaré esperándote. También puedes contactarnos por WhatsApp (${configuracion?.contacto?.telefono || '+56 9 2008 9281'}) cuando quieras. ¡Nos vemos! 🦀✨`;
                    }
